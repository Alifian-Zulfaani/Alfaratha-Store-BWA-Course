...
Route::group(['middleware' => ['auth']], function ()
{
    ...
    Route::post('/dashboard/products/gallery/upload', [App\Http\Controllers\DashboardProductsController::class, 'uploadGallery'])->name('dashboard-product-gallery-upload');
